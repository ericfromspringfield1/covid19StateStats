...
.then(function(data) {
  ...
  const percentPositive0 = data[0].positive / data[0].negative
  const percentPositive1 = data[1].positive / data[1].negative
  const percentPositive2 = data[2].positive / data[2].negative
  const percentPositive3 = data[3].positive / data[3].negative
  const percentPositive4 = data[4].positive / data[4].negative
  const percentPositive5 = data[5].positive / data[5].negative
  const percentPositive6 = data[6].positive / data[6].negative
  const percentPositive7 = data[7].positive / data[7].negative
  const percentPositive8 = data[8].positive / data[8].negative
  const percentPositive9 = data[9].positive / data[9].negative
  const percentPositive10 = data[10].positive / data[10].negative
  const percentPositive11 = data[11].positive / data[11].negative
  const percentPositive12 = data[12].positive / data[12].negative
  const percentPositive13 = data[13].positive / data[13].negative
  const percentPositive14 = data[14].positive / data[14].negative
  const percentPositive15 = data[15].positive / data[15].negative
  const percentPositive16 = data[16].positive / data[16].negative
  const percentPositive17 = data[17].positive / data[17].negative
  const percentPositive18 = data[18].positive / data[18].negative
  const percentPositive19 = data[19].positive / data[19].negative
  const percentPositive20 = data[20].positive / data[20].negative
  const percentPositive21 = data[21].positive / data[21].negative
  const percentPositive22 = data[22].positive / data[22].negative
  const percentPositive23 = data[23].positive / data[23].negative
  const percentPositive24 = data[24].positive / data[24].negative
  const percentPositive25 = data[25].positive / data[25].negative
  const percentPositive26 = data[26].positive / data[26].negative
  const percentPositive27 = data[27].positive / data[27].negative
  const percentPositive28 = data[28].positive / data[28].negative
  const percentPositive29 = data[29].positive / data[29].negative
  const percentPositive30 = data[30].positive / data[30].negative
  const percentPositive31 = data[31].positive / data[31].negative
  const percentPositive32 = data[32].positive / data[32].negative
  const percentPositive33 = data[33].positive / data[33].negative
  const percentPositive34 = data[34].positive / data[34].negative
  const percentPositive35 = data[35].positive / data[35].negative
  const percentPositive36 = data[36].positive / data[36].negative
  const percentPositive37 = data[37].positive / data[37].negative
  const percentPositive38 = data[38].positive / data[38].negative
  const percentPositive39 = data[39].positive / data[39].negative
  const percentPositive40 = data[40].positive / data[40].negative
  const percentPositive41 = data[41].positive / data[41].negative
  const percentPositive42 = data[42].positive / data[42].negative
  const percentPositive43 = data[43].positive / data[43].negative
  const percentPositive44 = data[44].positive / data[44].negative
  const percentPositive46 = data[45].positive / data[45].negative
  const percentPositive47 = data[47].positive / data[47].negative
  const percentPositive48 = data[48].positive / data[48].negative
  const percentPositive49 = data[49].positive / data[49].negative
  const percentPositive50 = data[50].positive / data[50].negative
